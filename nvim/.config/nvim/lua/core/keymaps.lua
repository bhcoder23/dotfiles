...
-- Esc
map("i", "jj", "<Esc>", { desc = "Quick exit insert mode to normal mode" })
map("t", "jj", "<C-\\><C-n>", { desc = "Quick exit terminal insert mode" })
...
map("x", "/", "<Esc>/\\%V", { desc = "Search only in visuakkkkl area" })
